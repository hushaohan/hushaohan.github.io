...
\emph{Towards Automatic Phone-to-Phone Communication for Vehicular
  Networking Applications}, \textsf{The 33rd IEEE International Conference on Computer
  Communications (InfoCom 2014)}, Toronto, Canada, April 27--May 2, 2014.
...
%Hengchang Liu, Suman Nath, Tarek Abdelzaher, Romit Roy Choudhury, \emph{eNav:
%  Smartphone-based Energy Efficient Location Sensing for Low-power
%  Vehicular Navigation}, \textsf{Under Submission} %MobiSys 2014
...
Liu, Tarek Abdelzaher, Jiawei Han, \emph{Generalized Decision
  ...
  Submission
%The 13th ACM/IEEE International Conference on Information Processing in Sensor Networks (IPSN 2014)}, Berlin Germany, April 15--17, 2014.
}
