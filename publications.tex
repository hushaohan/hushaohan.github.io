...
Tarek Abdelzaher, \emph{Proteus: Power Proportional Memory Cache
  Cluster in Data Centers}, under submission % \textsf{International Conference on Distributed Computing Systems}

\section{\sc Submitted}
\textbf{Shaohan Hu}, Lu Su, Hengchang Liu, Hongyan Wang, Tarek
Abdelzaher, \emph{SmartRoad: A Crowd-Sourced Traffic Regulator
  Detection and Identification System}, under submission % \textsf{ACM/IEEE Conference on Information Processing in Sensor Networks}
